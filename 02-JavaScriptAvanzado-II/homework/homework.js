...
/*
 const suma = counter(); --- guardamos a la funcion del scope globla en una variable.
 suma();    ----- asi es comi invocamos a la funcion.
*/ 
...
function cacheFunction(cb) {
  ...
  var cache = {}; // usa un objeto donde cada propiedad sea un argumento. aqui guardo los argumentos 
...
//getNombre(); undefined porque nombre no esta definido en la el scope global.
